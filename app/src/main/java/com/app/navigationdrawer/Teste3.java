...
public class Teste3 extends BaseActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_teste3, menu);
        return true;
    }
    ...
    private void setUpActionBar() {
        ...
        mActionBarToolbar.setTitle(getResources().getString(R.string.title_section3));
